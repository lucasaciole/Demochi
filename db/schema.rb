...
ActiveRecord::Schema.define(:version => 20130502145408) do
  ...
  add_index "sale_items", ["product_id"], :name => "items_product_id_fk"
  add_index "sale_items", ["sale_id"], :name => "items_sale_id_fk"
  ...
  add_foreign_key "sale_items", "products", :name => "items_product_id_fk"
  add_foreign_key "sale_items", "sales", :name => "items_sale_id_fk"
